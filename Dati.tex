...
\newcommand{\obiettiviObbligatori}{
	 \item \underline{\textit{O01}}: Acquisire esperienza nella realizzazione di un progetto concreto;
	 \item \underline{\textit{O02}}: Applicazione delle tecniche di programmazione funzionale ad un progetto web;
	 \item \underline{\textit{O03}}: Acquisire autonomia nell'autodidattica e nella gestione del tempo, in relazione a un progetto con SAL di rilascio.
	 
}

\newcommand{\obiettiviDesiderabili}{
	 \item \underline{\textit{D01}}: Corretta applicazione delle tecniche di unit testing per il rilascio di un prodotto privo di bug;
	 \item \underline{\textit{D02}}: Autonomia nella progettazione e realizzazione di un layout grafico funzionale e accattivante;
	 \item \underline{\textit{D03}}: Realizzazione dei codici sorgenti ben commentati e documentati.
}

\newcommand{\obiettiviFacoltativi}{
	\item \underline{\textit{F01}}: Redazione di una documentazione di rilascio.
}